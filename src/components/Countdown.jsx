  ...
  return (
    <section id="countdown-section" className="relative py-24 bg-[#050505] border-t border-zinc-900 overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-4 relative z-10 text-center">
        ...
        <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-red-950/60 border border-red-600/50 rounded-full text-red-500 font-mono-cyber text-xs tracking-widest uppercase mb-6 shadow-[0_0_15px_rgba(230,0,0,0.3)]">
          <AlertTriangle size={14} className="animate-pulse" />
          <span>OPERATION COUNTDOWN INITIALIZED</span>
        </div>

        <h2 className="font-bebas text-5xl sm:text-7xl text-white tracking-widest mb-3">
          TIME UNTIL THE <span className="text-red-600 text-glow-red">HEIST BEGINS</span>
        </h2>
        <p className="font-mono-cyber text-gray-400 text-sm max-w-xl mx-auto mb-12">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 max-w-4xl mx-auto">
          {timeUnits.map((unit) => (
            <div
              key={unit.label}
              className="relative group bg-zinc-950/80 border border-red-900/40 rounded-xl p-6 sm:p-8 flex flex-col items-center justify-center shadow-[0_0_30px_rgba(0,0,0,0.8)] hover:border-red-600 transition-all duration-300 transform hover:-translate-y-1"
            >
              {/* Top LED bar */}
              ...
              <div className="font-bebas text-6xl sm:text-8xl text-white tracking-wider font-bold mb-1 text-glow-red">
