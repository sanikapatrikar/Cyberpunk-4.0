...
import Web3ProblemStatement from "./pages/Web3ProblemStatement";
import Web3Submission from "./pages/Web3Submission";
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/web3-problem-statement" element={<Web3ProblemStatement />} />
        <Route path="/web3/problem-statement" element={<Web3ProblemStatement />} />
        <Route path="/web3-submission" element={<Web3Submission />} />
        <Route path="/web3/submission" element={<Web3Submission />} />
      </Routes>
    </BrowserRouter>
  );
